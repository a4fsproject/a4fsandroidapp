...
public class User_leave extends AppCompatActivity implements DataInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edt_from_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(User_leave.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String url = Constants.Webserive_Url + "user_leave.php";
                ...
                volley.CallVolley(url, params, "user_leave");
